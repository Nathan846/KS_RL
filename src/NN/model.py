...
import numpy as np
import src.envs
from src.utility.utils import clip_tensor 
...
############################ Pendulem #################################
class fake_pendu_env(src.envs.pendulum,nn.Module):
    '''
...
class fake_burgers_env(src.envs.burgers, nn.Module):
...
class fake_ks_env(src.envs.ks,nn.Module):
